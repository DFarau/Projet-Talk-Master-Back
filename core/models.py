...
class User(AbstractUser):
    ...
    role = models.CharField(max_length=10, choices=ROLE_CHOICES, default='public', verbose_name="Rôle")
...
class Talk(models.Model):
    ...
    speaker = models.ForeignKey(
        ...
        related_name='talks',
        limit_choices_to={'role': 'speaker'},  # Limite le choix aux utilisateurs avec role='speaker'
    ...
    def clean(self):
        ...
        if self.status == 'scheduled':
            ...
            if not self.timeslot:
                raise ValidationError("Un créneau horaire doit être attribué pour planifier un talk.")
        ...
        if self.speaker and self.timeslot:
            ...
            if overlapping_talks.exists():
                raise ValidationError("Ce conférencier a déjà un talk programmé sur ce créneau horaire.")
